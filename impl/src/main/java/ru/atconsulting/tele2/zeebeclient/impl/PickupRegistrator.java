 ...
 */
public class PickupRegistrator implements JobHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(PickupRegistrator.class);

    ZeebeClient client;

    @Inject
    public PickupRegistrator(ZeebeClient client) {
        this.client = client;
        client.newWorker()
                .jobType("pickup-registration")
                .handler(this)
    ...
    public void handle(JobClient client, ActivatedJob job) {
        ...
        LOGGER.info("Pickup registered for order: {}", order.getOrderId());
